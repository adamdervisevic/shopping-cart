    ...
    return (
        <header className="bg-white shadow-md p-4 flex justify-between item-center">
        ...
        <div className="relative">
            ...
            {showDropdown && (
            <div className="absolute right-0 mt-2 w-80 bg-white border-rounded shadow-large z-50">
                <div className="p-4">
                ...
                {cart.length === 0 ? (
                    ...
                    <>
                    <ul className="max-h-600 overflow-y-auto divide-y divide-gray-200">
                        {cart.map((item) => (
                        <li
                            key={item.id}
